function y = isodifstep1(x, d)
% ISODIFSTEP1   1D Isotropic diffusion step
%
%    y = ISODIFSTEP1(x, d) calculates de isotropic (scalar) diffusion
%    step "y" based on the signal "x" and on the diffusivity "d". If
