classdef ALYtools_menu_controller < handle
    ...
    methods
       ...
       function menu_file_load_callback(obj, ~, ~)
           try
            [filename,pathname] = uigetfile({'*.tif;*.tiff;*.gif;*.avi;*.czi;*.png;*.bmp;*.jpg;*.jpeg;*.lsm;*.sdt','Image Files'}, ...
        ...
        function menu_file_load_multiple_callback(obj, ~, ~)
            try
                [filenames,pathname] = uigetfile({'*.tif;*.tiff;*.gif;*.avi;*.czi;*.png;*.bmp;*.jpg;*.jpeg;*.lsm;*.sdt;*.txt','Image Files'},...
